...
# -*- coding: utf-8 -*-
#
# diffpy.cmi documentation build configuration file, created by  # noqa: E501
...
# abbreviations
ab_authors = "Simon Billinge and members of the Billinge Group"
...
modindex_common_prefix = ["diffpy.cmi"]
...
basename = "diffpy.cmi".replace(" ", "").replace(".", "")
